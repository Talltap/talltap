...
<span class="isolate inline-flex rounded-md shadow-sm" x-data="youtube()">
        <button type="button"
                class="relative -ml-px inline-flex items-center px-2 py-2 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-10 rounded-l-md rounded-r-md"
        ...
        >
                ...
                <x-ri-youtube-line class="w-4 h-4" />
              </button>
        </span>
<script>
        function youtube() {
          ...
          `,
                                        ...
                                        preConfirm: () => {
                                                ...
                                                if (!url) {
                                                        Swal.showValidationMessage(`Please enter a youtube url`);
                                                }
                                                return { url };
                                        }
                                }).then((result) => {
