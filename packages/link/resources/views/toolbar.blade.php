...
<span>
    <button
        ...
        @click="openModal()"
        @class([
            "relative -ml-px inline-flex items-center rounded-l-md rounded-r-md px-2 py-2 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-10",
        ])
